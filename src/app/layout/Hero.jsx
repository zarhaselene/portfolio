...
const Hero = () => {
  ...
  return (
    <div className="h-[90vh] w-full relative overflow-hidden ">
      <div className="max-w-[1300px] w-full absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 xl:max-w-[800px] lg:max-w-[640px] sm:max-w-[480px] border-2">
        {/* "Front-End" Section */}
        <div className="topHeading flex items-center justify-center">
          ...
          <span
            ...
            mx-[10px] !min-w-[20px] sm:h-[15px] sm:mx-[15px] lg:h-[20px] !lg:mx-[50px]"
