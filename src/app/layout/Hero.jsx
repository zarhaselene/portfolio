	...
	return (
		...
		>
			<h1 className="w-full absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 xl:max-w-[1280px] lg:max-w-[900px] sm:max-w-[580px]">
				<span className="sr-only">Front end Developer Portfolio - Zarha</span>
				{/* Animated Heading */}
				<motion.span
            ...
            mx-[10px] min-w-[50px] sm:h-[15px] sm:mx-[15px] lg:h-[30px] lg:!mx-[50px]"
				...
				<span className="heading flex flex-col lg:items-start xl:flex-row xl:items-center xl:justify-between">
					...
					>
						...
						>
							I'm a Stockholm-based frontend developer who enjoys turning design
							into functional, responsive, and accessible digital experiences.
							With an eye for detail and a strong interest in both visual design
							and code, I build websites that feel intuitive and easy
							to use.
						</motion.p>
					</motion.div>
				</span>
